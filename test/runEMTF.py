...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring( (
		...
		'/store/mc/Phase2HLTTDRWinter20DIGI/DsToTauTo3Mu_TuneCP5_14TeV-pythia8/GEN-SIM-DIGI-RAW/PU200_withNewMB_110X_mcRun4_realistic_v3_ext1-v1/50000/FF2ED188-D496-9C4A-96E7-6B3184C3DC48.root'
     ) ),
...
# process.phase2L1EMTFSequence = cms.Sequence(process.rpcRecHitsForEMTF+process.phase2L1EMTFProducer)
process.phase2L1EMTFSequence = cms.Sequence(process.rpcRecHitsForEMTF +
                                            process.simCscTriggerPrimitiveDigisForEMTF+process.phase2L1EMTFProducer)
...
process.testpath=cms.Path(process.CalibratedDigis*process.dtTriggerPhase2PrimitiveDigis*process.phase2L1EMTFSequence)
